...
class WC_Post_types {
	...
	public static function register_post_types() {
			...
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							...
							'search_items'          => __( 'Шукати товар', 'woocommerce' ),
							'not_found'             => __( 'Товарів не знайдено', 'woocommerce' ),
		...
		wc_register_order_type(
			...
			apply_filters( 'woocommerce_register_post_type_shop_order',
				array(
					'labels'              => array(
							'name'               => __( 'Замовлення', 'woocommerce' ),
							'singular_name'      => _x( 'Замовлення', 'shop_order post type singular name', 'woocommerce' ),
							'add_new'            => __( 'Додати замовлення', 'woocommerce' ),
							'add_new_item'       => __( 'Додати нове замовлення', 'woocommerce' ),
							'edit'               => __( 'Редагувати', 'woocommerce' ),
							'edit_item'          => __( 'Редагувати замовлення', 'woocommerce' ),
							'new_item'           => __( 'Нове замовлення', 'woocommerce' ),
							'view'               => __( 'Переглянути замовлення', 'woocommerce' ),
							'view_item'          => __( 'Переглянути замовлення', 'woocommerce' ),
							'search_items'       => __( 'Шукати замовлення', 'woocommerce' ),
	...
	public static function register_post_status() {
		...
		register_post_status( 'wc-processing', array(
			'label'                     => _x( 'У роботі', 'Order status', 'woocommerce' ),
			'public'                    => false,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'У роботі <span class="count">(%s)</span>', 'У роботі <span class="count">(%s)</span>', 'woocommerce' )
		) );
		...
		register_post_status( 'wc-completed', array(
			'label'                     => _x( 'Виконано', 'Order status', 'woocommerce' ),
			'public'                    => false,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Виконано <span class="count">(%s)</span>', 'Виконано <span class="count">(%s)</span>', 'woocommerce' )
		) );
