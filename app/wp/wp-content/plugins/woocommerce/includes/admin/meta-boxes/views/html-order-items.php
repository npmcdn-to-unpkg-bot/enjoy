	...
	<table cellpadding="0" cellspacing="0" class="woocommerce_order_items">
		<thead>
			<tr>
				...
				<th class="item sortable" colspan="2" data-sort="string-ins"><?php _e( 'шт.', 'woocommerce' ); ?></th>
				...
				<th class="line_cost sortable" data-sort="float"><?php _e( 'Загальна сума', 'woocommerce' ); ?></th>
