...
class WC_Meta_Box_Order_Data {
	...
	public static function output( $post ) {
		...
		<div class="panel-wrap woocommerce">
			<input name="post_title" type="hidden" value="<?php echo empty( $post->post_title ) ? __( 'Замовлення', 'woocommerce' ) : esc_attr( $post->post_title ); ?>" />
			<input name="post_status" type="hidden" value="<?php echo esc_attr( $post->post_status ); ?>" />
			<div id="order_data" class="panel">

				<h2><?php echo esc_html( sprintf( _x( '%s #%s деталі', 'Замовлення #123 деталі', 'woocommerce' ), $order_type_object->labels->singular_name, $order->get_order_number() ) ); ?></h2>
				...
				<div class="order_data_column_container">
					...
					<div class="order_data_column">
						<h4>
							<?php _e( 'Деталі замовлення', 'woocommerce' ); ?>
