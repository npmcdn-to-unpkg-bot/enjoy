			...
			<table class="wc-setup-pages" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="page-description"><?php _e( 'Опис', 'woocommerce' ); ?></th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<form method="post">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<?php printf( __( 'A total of %s per order and/or %s per шт.', 'woocommerce' ), get_woocommerce_currency_symbol() . ' <input type="text" id="shipping_cost_domestic" name="shipping_cost_domestic" size="5" value="' . esc_attr( $shipping_cost_domestic ) . '" />', get_woocommerce_currency_symbol() . ' <input type="text" id="shipping_cost_domestic_item" name="shipping_cost_domestic_item" size="5" />' ); ?>
					</td>
				</tr>
				<tr>
	...
	public function wc_setup_payments() {
		...
		<form method="post">
			...
			<table class="form-table">
				...
				<tr>
					<th scope="row"><label for="woocommerce_enable_cod"><?php _e( 'Оплата при отриманні', 'woocommerce' ); ?></label></th>
					<td>
						<label><input type="checkbox" id="woocommerce_enable_cod" name="woocommerce_enable_cod" class="input-checkbox" value="yes" <?php checked( ( isset( $cod_settings['enabled'] ) && 'yes' === $cod_settings['enabled'] ), true ); ?> /> <?php _e( 'Включити оплата при отриманні', 'woocommerce' ); ?></label>
					</td>
				</tr>
				<tr>
